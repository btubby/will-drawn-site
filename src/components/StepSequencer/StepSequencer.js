...
// https://groups.google.com/forum/#!msg/tonejs/1TTD38NSSAk/togRBkSwAwAJ
// https://github.com/sam-parsons/react-step-sequencer
...
const Sequencer = () => {
  ...
  function setPattern({ x, y, value }) {
    console.log(`setPatters x${x} y${y} value${value}`)
